...
$order_by='ORDER BY a.update_time DESC LIMIT 0,15';
$sql.=$order_by;
...
<table width="100" border="0" cellspacing="0" cellpadding="0" class="ydstickets-table">
            <tr>
                ...
                <th align="left" valign="middle"><?php _e('Subject','ydssupport'); ?></th>
                <th align="left" valign="middle"><?php _e('User','ydssupport'); ?></th>
          ...
          <tr onclick="viewticketonFront(<?php echo $ticketsval->ydstsID; ?>);">
                ...
                <td><?php echo stripcslashes($ticketsval->subject); ?></td>
...
<div class="open"><?php _e('Waiting Customer Reply','ydssupport'); ?></div>
...
<?php } ?></td>
                <td align="center" valign="middle"><div class="date"><?php echo $modified; ?></div></td>
              </tr>
              <?php } ?>
